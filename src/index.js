...
class App extends React.Component{
  ...
  handleAddItemChild(parent, name){
    base.push('/todoList/'+parent,{
      data: {name: name, type: 'Grizzly'},
    })
  }
  ...
  render(){
    return (
      <div>
        ...
        <Button onClick={this.handleAddItemChild.bind(this, 'hahahaha')}> test </Button>
        <Button onClick={this.handleAddItemChild.bind(this, '-KBqQLtYcPsiEUBSYr_z', 'hahahaha')}> test </Button>
      </div>
    )
  }
}
